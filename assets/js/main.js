...
search.addEventListener('click', (event) => {
    ...
    if (locationInput == '') {
        ...
        locationInput = locationTest.value;
    }
    ...
    fetch(url)
        ...
        .then((data) => {
            ...
            icon.innerHTML= `<img src='https://openweathermap.org/img/wn/${iconInput}@2x.png' alt="test">`;
            ...
            sunrise.innerHTML = new Date(sunriseInput * 1000).toLocaleTimeString();
            sunset.innerHTML = new Date(sunsetInput * 1000).toLocaleTimeString();
